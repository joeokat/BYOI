    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>
          ...
          safe space for introverts to explore their personalities and discover
          what makes them unique. We understand that self-discovery can be a
          daunting task, and that's why we've created a user-friendly platform
          with personalized assessments and resources to help guide you on your
          journey.
        </Text>
        <Text style={styles.subtitle}>
        ...
        <Text style={styles.subtitle}>
          ...
          that's why we offer "Discovering the Weird and Wonderful You" meetup.
          It's an interactive event that celebrates your uniqueness and helps
          you discover your hidden talents and passions.
        </Text>
        <Text style={styles.subtitle}>
        ...
        <View>
          ...
          <Text style={styles.subtitle}>
            Greetings, my name is J@shua Ofosu, CEO of Fleet Labs Ghana and
            author of Inside Out. As an introvert myself, I understand the
            challenges of feeling limited by social norms and expectations.
            However, I believe that our introverted nature is a gift that can
            help us become explorers of life in our own unique way.
          </Text>
          <Text style={styles.subtitle}>
            That's why I'm reaching out to invite you, my fellow introverts, to
            a space where we can be ourselves without fear of judgment or
            attracting unwanted attention. It's a place where we can embrace our
            curious minds and ask the questions that drive our intellectual
            curiosity.
          </Text>
          <Text style={styles.subtitle}>
